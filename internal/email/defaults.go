...
func GetDefaultTemplate(typeCode string) *models.EmailTemplate {
	...
	case TypeCentroraInvitation:
		return defaultCentroraInvitation()
	case TypeCentroraProjectInvitation:
		return defaultCentroraProjectInvitation()
	case TypeCentroraEnvInvitation:
		return defaultCentroraEnvInvitation()
	case TypePermissioInvitation:
		return defaultPermissioInvitation()
	default:
		return nil
	}
}
...
func defaultCentroraInvitation() *models.EmailTemplate {
	return &models.EmailTemplate{
		Name:           "Default Organization Invitation",
...
<table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background-color:#ffffff;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.08);overflow:hidden;">
  ...
  <tr><td style="background-color:#f8fafc;padding:24px 40px;text-align:center;border-top:1px solid #e2e8f0;">
    <p style="color:#a0aec0;font-size:12px;margin:0;">This email was sent by {{.AppName}}. Please do not reply to this email.</p>
		...
		BodyText: `You've been invited to join {{.OrganizationName}}
...
func defaultCentroraProjectInvitation() *models.EmailTemplate {
	return &models.EmailTemplate{
		Name:           "Default Project Invitation",
...
<table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background-color:#ffffff;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.08);overflow:hidden;">
  ...
  <tr><td style="padding:40px;">
    <h2 style="color:#1a1a2e;margin:0 0 16px;font-size:20px;">You've been invited to a project!</h2>
    <p style="color:#4a5568;font-size:16px;line-height:1.6;margin:0 0 24px;">
      <strong>{{.InviterName}}</strong> has invited you to join the project <strong>{{.ProjectName}}</strong>
      in <strong>{{.OrganizationName}}</strong> as <strong>{{.Role}}</strong>.
    </p>
    <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 auto 24px;">
    <tr><td style="background-color:#4f46e5;border-radius:6px;">
      <a href="{{.AcceptURL}}" style="display:inline-block;padding:14px 32px;color:#ffffff;text-decoration:none;font-size:16px;font-weight:600;">Accept Invitation</a>
  ...
  <tr><td style="background-color:#f8fafc;padding:24px 40px;text-align:center;border-top:1px solid #e2e8f0;">
    <p style="color:#a0aec0;font-size:12px;margin:0;">This email was sent by {{.AppName}}. Please do not reply to this email.</p>
		...
		BodyText: `You've been invited to project {{.ProjectName}}

{{.InviterName}} has invited you to join the project {{.ProjectName}} in {{.OrganizationName}} as {{.Role}}.
...
func defaultPermissioInvitation() *models.EmailTemplate {
	return &models.EmailTemplate{
		Name:           "Default Permissio Organization Invitation",
		Subject:        "You've been invited to join {{.OrganizationName}} on Permissio",
		TemplateEngine: models.TemplateEngineGoTemplate,
		BodyHTML: `<!DOCTYPE html>
<html>
<head>
...
<table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background-color:#ffffff;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.08);overflow:hidden;">
  ...
  <tr><td style="background-color:#f8fafc;padding:24px 40px;text-align:center;border-top:1px solid #e2e8f0;">
    <p style="color:#a0aec0;font-size:12px;margin:0;">This email was sent by Permissio. Please do not reply to this email.</p>
		...
		BodyText: `You've been invited to join {{.OrganizationName}} on Permissio
...
func defaultCentroraEnvInvitation() *models.EmailTemplate {
	return &models.EmailTemplate{
		Name:           "Default Environment Invitation",
		Subject:        "You've been invited to environment {{.EnvName}}",
		TemplateEngine: models.TemplateEngineGoTemplate,
		BodyHTML: `<!DOCTYPE html>
<html>
<head>
...
<table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background-color:#ffffff;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.08);overflow:hidden;">
  ...
  <tr><td style="padding:40px;">
    <h2 style="color:#1a1a2e;margin:0 0 16px;font-size:20px;">You've been invited to an environment!</h2>
    <p style="color:#4a5568;font-size:16px;line-height:1.6;margin:0 0 24px;">
      <strong>{{.InviterName}}</strong> has invited you to join the environment <strong>{{.EnvName}}</strong>
      in project <strong>{{.ProjectName}}</strong> ({{.OrganizationName}}) as <strong>{{.Role}}</strong>.
    </p>
    <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 auto 24px;">
    <tr><td style="background-color:#4f46e5;border-radius:6px;">
      <a href="{{.AcceptURL}}" style="display:inline-block;padding:14px 32px;color:#ffffff;text-decoration:none;font-size:16px;font-weight:600;">Accept Invitation</a>
  ...
  <tr><td style="background-color:#f8fafc;padding:24px 40px;text-align:center;border-top:1px solid #e2e8f0;">
    <p style="color:#a0aec0;font-size:12px;margin:0;">This email was sent by {{.AppName}}. Please do not reply to this email.</p>
		...
		BodyText: `You've been invited to environment {{.EnvName}}

{{.InviterName}} has invited you to join the environment {{.EnvName}} in project {{.ProjectName}} ({{.OrganizationName}}) as {{.Role}}.
